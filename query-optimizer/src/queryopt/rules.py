...
if TYPE_CHECKING:
    from queryopt.expressions import LogicalExpr
    from queryopt.memo import Group, Memo
...
class Rule:
    ...
    def apply(self, expr: LogicalExpr, group: Group, memo: Memo) -> list[Any]:
