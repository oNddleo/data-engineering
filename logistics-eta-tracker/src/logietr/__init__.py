...
if TYPE_CHECKING:
    from logietr.eta import ETAPrediction, LaneStats, build_lane_stats, predict_eta
    ...
    from logietr.leaderboard import CarrierScorecard, carrier_scorecards, rank_by_on_time
    ...
    from logietr.sla import Breach, BreachKind, find_overdue, find_stuck
    from logietr.tracker import ShipmentStatus, apply_events, state_distribution
