...
def _seed_banks() -> None:
    ...
    BANKS = [
        ...
        Bank(
            code="BIDV",
            name_vi="BIDV",
            name_en="Bank for Investment and Development",
            website="https://www.bidv.com.vn",
        ),
        Bank(
            code="CTG",
            name_vi="VietinBank",
            name_en="Vietnam Joint Stock Commercial Bank",
            website="https://www.vietinbank.vn",
        ),
        Bank(
            code="TCB",
            name_vi="Techcombank",
            name_en="Vietnam Technological & Commercial Bank",
        ...
        Bank(
            code="STB",
            name_vi="Sacombank",
            name_en="Sai Gon Thuong Tin Bank",
            website="https://www.sacombank.com",
        ),
        Bank(
            code="TPB",
            name_vi="TPBank",
        ...
        Bank(
            code="VIB",
            name_vi="VIB",
            name_en="Vietnam International Bank",
            website="https://www.vib.com.vn",
        ),
        Bank(
            code="OCB",
            name_vi="OCB",
            name_en="Orient Commercial Bank",
            website="https://www.ocb.com.vn",
        ),
        Bank(
            code="SEA",
            name_vi="SeABank",
            name_en="Southeast Asia Commercial Bank",
